...
unsigned long find_set(unsigned long address){
	return (address>>num_bits_offset()) & ((1<<num_bits_set()) - 1);
}
...
unsigned long find_tag(unsigned long address){
	unsigned long shift_value = num_bits_offset() + num_bits_set();
	return (address >> shift_value);  
}
...
unsigned long find_offset(unsigned long address){
	return (address >> 0) & ((1<<num_bits_offset()) -1);
}
/**********************************************************************/
